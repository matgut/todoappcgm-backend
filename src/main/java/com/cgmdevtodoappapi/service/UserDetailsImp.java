...
@Getter
//Si queremos obtener más datos (id, email...), podemos crear una implementación de esta interfaz UserDetails.
public class UserDetailsImp implements UserDetails {
    ...
    @JsonIgnore//no pida este campo al momento de registro
    ...
    public static UserDetailsImp build(UserApp user) {
